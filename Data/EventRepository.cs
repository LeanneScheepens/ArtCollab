...
namespace Data
{
    public class EventRepository : IEventRepository
    {
        ...
        public void CreateEvent(Event evt)
        {
            ...
            connection.Open();
            var cmd = new SqlCommand(@"INSERT INTO Events (Title, Description, Owner) 
        ...
        public List<Event> GetAllEvents()
        {
            ...
            using var connection = new SqlConnection(_connectionString);
            connection.Open();
            var cmd = new SqlCommand("SELECT Id, Title, Description, Owner FROM Events", connection);
        ...
        public Event GetEventById(int id)
        {
            using var connection = new SqlConnection(_connectionString);
            connection.Open();
            var cmd = new SqlCommand("SELECT Id, Title, Description, Owner FROM Events WHERE Id = @Id", connection);
